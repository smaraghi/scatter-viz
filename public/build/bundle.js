...
var app = (function () {
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(circle, "cx", circle_cx_value = "" + (/*xScale*/ ctx[8](/*country*/ ctx[21].health_expenditure) + "px"));
    			attr_dev(circle, "cy", circle_cy_value = "" + (/*yScale*/ ctx[7](/*country*/ ctx[21].life_expectancy) + "px"));
    			attr_dev(circle, "r", circle_r_value = /*rScale*/ ctx[6](/*country*/ ctx[21].gdp));
    			add_location(circle, file$2, 58, 6, 1320);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, circle, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*xScale, data*/ 257 && circle_cx_value !== (circle_cx_value = "" + (/*xScale*/ ctx[8](/*country*/ ctx[21].health_expenditure) + "px"))) {
    				attr_dev(circle, "cx", circle_cx_value);
    			}

    			if (dirty & /*yScale, data*/ 129 && circle_cy_value !== (circle_cy_value = "" + (/*yScale*/ ctx[7](/*country*/ ctx[21].life_expectancy) + "px"))) {
    				attr_dev(circle, "cy", circle_cy_value);
    			}

    			if (dirty & /*rScale, data*/ 65 && circle_r_value !== (circle_r_value = /*rScale*/ ctx[6](/*country*/ ctx[21].gdp))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:4) {#each data as country}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text$1(t_value);
    			attr_dev(line, "x1", /*padding*/ ctx[9].left);
    			attr_dev(line, "x2", line_x__value_1 = /*xScale*/ ctx[8](22));
    			add_location(line, file$2, 70, 10, 1665);
    			attr_dev(text_1, "x", /*padding*/ ctx[9].left - 8);
    			attr_dev(text_1, "y", "+4");
    			add_location(text_1, file$2, 71, 10, 1727);
    			attr_dev(g, "class", g_class_value = "tick tick-" + /*tick*/ ctx[16]);
    			attr_dev(g, "transform", g_transform_value = "translate(0, " + /*yScale*/ ctx[7](/*tick*/ ctx[16]) + ")");
    			add_location(g, file$2, 69, 8, 1585);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*xScale*/ 256 && line_x__value_1 !== (line_x__value_1 = /*xScale*/ ctx[8](22))) {
    				attr_dev(line, "x2", line_x__value_1);
    			}

    			if (dirty & /*yTicks*/ 8 && t_value !== (t_value = /*tick*/ ctx[16] + "")) set_data_dev(t, t_value);

    			if (dirty & /*yTicks*/ 8 && g_class_value !== (g_class_value = "tick tick-" + /*tick*/ ctx[16])) {
    				attr_dev(g, "class", g_class_value);
    			}

    			if (dirty & /*yScale, yTicks*/ 136 && g_transform_value !== (g_transform_value = "translate(0, " + /*yScale*/ ctx[7](/*tick*/ ctx[16]) + ")")) {
    ...
    function create_each_block$1(ctx) {
    	...
    	let line_y__value_1;
    	let text_1;
    	let t_value = /*formatter*/ ctx[10](/*tick*/ ctx[16]) + "";
    	let t;
    	let text_1_y_value;
    	let g_transform_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "y2", line_y__value_1 = /*yScale*/ ctx[7](13));
    			add_location(line, file$2, 80, 10, 1966);
    			attr_dev(text_1, "y", text_1_y_value = /*height*/ ctx[2] - /*padding*/ ctx[9].bottom + 16);
    			add_location(text_1, file$2, 81, 10, 2025);
    			attr_dev(g, "class", "tick");
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*xScale*/ ctx[8](/*tick*/ ctx[16]) + ",0)");
    			add_location(g, file$2, 79, 8, 1899);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, line);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*yScale*/ 128 && line_y__value !== (line_y__value = /*yScale*/ ctx[7](0))) {
    				attr_dev(line, "y1", line_y__value);
    			}

    			if (dirty & /*yScale*/ 128 && line_y__value_1 !== (line_y__value_1 = /*yScale*/ ctx[7](13))) {
    				attr_dev(line, "y2", line_y__value_1);
    			}

    			if (dirty & /*xTicks*/ 16 && t_value !== (t_value = /*formatter*/ ctx[10](/*tick*/ ctx[16]) + "")) set_data_dev(t, t_value);

    			if (dirty & /*height*/ 4 && text_1_y_value !== (text_1_y_value = /*height*/ ctx[2] - /*padding*/ ctx[9].bottom + 16)) {
    				attr_dev(text_1, "y", text_1_y_value);
    			}

    			if (dirty & /*xScale, xTicks*/ 272 && g_transform_value !== (g_transform_value = "translate(" + /*xScale*/ ctx[8](/*tick*/ ctx[16]) + ",0)")) {
    				attr_dev(g, "transform", g_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(79:6) {#each xTicks as tick}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			text_1 = svg_element("text");
    			t = text$1("Vaccine Diplomacy Index");
    			attr_dev(g0, "class", "axis y-axis");
    			add_location(g0, file$2, 67, 4, 1524);
    			attr_dev(g1, "class", "axis x-axis");
    			add_location(g1, file$2, 77, 4, 1838);
    			attr_dev(text_1, "class", "interactive__subheading subheading-x");
    			attr_dev(text_1, "stroke", "black");
    			attr_dev(text_1, "fill", "currentColor");
    			add_location(text_1, file$2, 85, 4, 2131);
    			add_location(svg, file$2, 55, 2, 1262);
    			attr_dev(figure_1, "class", "chart");
    			add_render_callback(() => /*figure_1_elementresize_handler*/ ctx[13].call(figure_1));
    			add_location(figure_1, file$2, 49, 0, 1151);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*xScale, data, yScale, rScale*/ 449) {
    			...
    			if (dirty & /*yTicks, yScale, padding, xScale*/ 904) {
    			...
    			if (dirty & /*xScale, xTicks, height, padding, formatter, yScale*/ 1940) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('maxXVal' in $$props) $$invalidate(14, maxXVal = $$props.maxXVal);
    		if ('maxYVal' in $$props) $$invalidate(15, maxYVal = $$props.maxYVal);
    		if ('rScale' in $$props) $$invalidate(6, rScale = $$props.rScale);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*xTicks, width*/ 18) {
    			$$invalidate(8, xScale = linear().domain([0, Math.max(...xTicks)]).range([padding.left, width - padding.right]));
    		}

    		if ($$self.$$.dirty & /*yTicks, height*/ 12) {
    			$$invalidate(7, yScale = linear().domain([40, Math.max(...yTicks)]).range([height - padding.bottom, padding.top]));
    		}

    		if ($$self.$$.dirty & /*data*/ 1) {
    			$$invalidate(6, rScale = sqrt().domain(extent(data, d => d.gdp)).range([4, 25]));
    		}
    	};

    	$$invalidate(4, xTicks = range(0, maxXVal, 1500));
    	$$invalidate(3, yTicks = range(40, maxYVal + 10, 10));
    ...
    /* src/components/Legend.svelte generated by Svelte v3.46.4 */
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(circle, "fill", circle_fill_value = /*d*/ ctx[4].fill);
    			attr_dev(circle, "region", circle_region_value = /*d*/ ctx[4].region);
    			attr_dev(circle, "data-color", circle_data_color_value = /*d*/ ctx[4].text);
    			add_location(circle, file$1, 28, 6, 1075);
    			attr_dev(text_1, "class", "legend__labels");
    			attr_dev(text_1, "x", "10%");
    			attr_dev(text_1, "y", 14 + /*legendIndex*/ ctx[6] * 25 + 'px');
    			add_location(text_1, file$1, 35, 6, 1259);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, circle, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*legendValues*/ 2 && circle_r_value !== (circle_r_value = /*d*/ ctx[4].r)) {
    				attr_dev(circle, "r", circle_r_value);
    			}

    			if (dirty & /*legendValues*/ 2 && circle_fill_value !== (circle_fill_value = /*d*/ ctx[4].fill)) {
    				attr_dev(circle, "fill", circle_fill_value);
    			}

    			if (dirty & /*legendValues*/ 2 && circle_region_value !== (circle_region_value = /*d*/ ctx[4].region)) {
    				attr_dev(circle, "region", circle_region_value);
    			}

    			if (dirty & /*legendValues*/ 2 && circle_data_color_value !== (circle_data_color_value = /*d*/ ctx[4].text)) {
    				attr_dev(circle, "data-color", circle_data_color_value);
    			}

    			if (dirty & /*legendValues*/ 2 && t_value !== (t_value = /*d*/ ctx[4].text + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(circle);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(figcaption, file$1, 23, 2, 872);
    			attr_dev(svg, "class", "legend__color-circles");
    			add_location(svg, file$1, 26, 2, 990);
    			attr_dev(figure, "class", "interactive__color-legend legend");
    			add_location(figure, file$1, 22, 0, 820);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('incomeData' in $$props) $$invalidate(3, incomeData = $$props.incomeData);
